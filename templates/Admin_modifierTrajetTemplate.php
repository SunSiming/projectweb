...
<div class='col-lg-8'>
            ...
            <form action="index.php?c=user&a=AdminModificationTrajet" method="post">
              ...
              <button class="btn btn-primary btn-block" data-toggle="modal" data-target="#exampleModal" type="submit">Valider les modifications</button>
